  ...
  return (
    <>
      {links.map((link) => {
        ...
        return (
          /* The <Link> component is a Next.js component that allows you to link to other pages in the application. It's similar to the <a> element, but instead of <a href="...">, you use <Link href="...">.
